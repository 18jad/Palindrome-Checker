var input = document.getElementById("checker"), form = document.getElementById("checker-form"), btn = document.getElementById("checker-btn"), word = document.getElementById("pal-word"), ans = document.getElementById("pal-ans"), green = document.getElementById("bg-green"), red = document.getElementById("bg-red");
